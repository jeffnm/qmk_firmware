 ...
 * |------+------+------+------+------+------| |------+------+------+------+------+------|
 * |ADJUST| Ctrl | Alt  | GUI  |L/Spc | Bksp | |Enter |R/Spc | Left | Down |  Up  |Right |
 * `-----------------------------------------| |-----------------------------------------'
 */
[_QWERTY] = KEYMAP( \
 ...
 * |------+------+------+------+------+------| |------+------+------+------+------+------|
 * | LEDs |  F7  |  F8  |  F9  |  F10 |  F11 | |  F12 |ISO ~ |ISO | | Home | End  |      |
 * |------+------+------+------+------+------| |------+------+------+------+------+------|
 * |      |      |      |      |      |      | |      |      | Next | Vol- | Vol+ | Play |
 * `-----------------------------------------| |-----------------------------------------'
 */
[_LOWER] = KEYMAP( \
  ...
  BL_STEP, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  S(KC_NUHS), S(KC_NUBS), KC_HOME, KC_END,  BL_STEP, \
 ...
 * |------+------+------+------+------+------| |------+------+------+------+------+------|
 * | LEDs |  F7  |  F8  |  F9  |  F10 |  F11 | |  F12 |ISO # |ISO / |Pg Up |Pg Dn |      |
 * |------+------+------+------+------+------| |------+------+------+------+------+------|
 * |      |      |      |      |      |      | |      |      | Next | Vol- | Vol+ | Play |
 * `-----------------------------------------| |-----------------------------------------'
 */
[_RAISE] = KEYMAP( \
  ...
  BL_STEP, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NUHS, KC_NUBS, KC_PGUP, KC_PGDN, BL_STEP, \
  _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
),
